...
/*评论*/
insert into comment(movie_id,user_id,content,addtime) values(11,14,"好看",now());
insert into comment(movie_id,user_id,content,addtime) values(11,22,"不错",now());
insert into comment(movie_id,user_id,content,addtime) values(11,21,"经典",now());
insert into comment(movie_id,user_id,content,addtime) values(11,11,"给力",now());
insert into comment(movie_id,user_id,content,addtime) values(8,15,"难看",now());
insert into comment(movie_id,user_id,content,addtime) values(8,16,"无聊",now());
insert into comment(movie_id,user_id,content,addtime) values(8,17,"乏味",now());
insert into comment(movie_id,user_id,content,addtime) values(8,18,"无感",now());

ALTER TABLE comment auto_increment=1;

/*收藏*/
insert into moviecol(movie_id,user_id,addtime) values(6,21,now());
insert into moviecol(movie_id,user_id,addtime) values(6,22,now());
insert into moviecol(movie_id,user_id,addtime) values(6,23,now());
insert into moviecol(movie_id,user_id,addtime) values(6,14,now());
insert into moviecol(movie_id,user_id,addtime) values(8,15,now());
insert into moviecol(movie_id,user_id,addtime) values(8,16,now());
insert into moviecol(movie_id,user_id,addtime) values(8,17,now());
insert into moviecol(movie_id,user_id,addtime) values(8,18,now());

ALTER TABLE moviecol auto_increment=1;

/*会员登录日志*/
insert into userlog(user_id,ip,addtime) values(21,"192.168.4.1",now());
insert into userlog(user_id,ip,addtime) values(22,"192.168.4.2",now());
insert into userlog(user_id,ip,addtime) values(23,"192.168.4.3",now());
insert into userlog(user_id,ip,addtime) values(24,"192.168.4.4",now());
insert into userlog(user_id,ip,addtime) values(15,"192.168.4.5",now());
insert into userlog(user_id,ip,addtime) values(16,"192.168.4.6",now());
insert into userlog(user_id,ip,addtime) values(17,"192.168.4.7",now());
insert into userlog(user_id,ip,addtime) values(18,"192.168.4.8",now());
insert into userlog(user_id,ip,addtime) values(19,"192.168.4.9",now());
